    ...
    <Link to="/" className="flex items-center gap-5">
        ...
        <p className="font-bold text-content lg:text-title">CIERVUS</p>
            ...
            <nav className="text-white flex justify-center gap-7 w-2/4 flex-col text-center mt-3 lg:mt-0  h-full">
                <Link className="font-bold text-content2 lg:text-content" to="/">
                    SOBRE NOSOTROS
                </Link>
                <Link className="font-bold text-content2 lg:text-content" to="/">
                    PRODUCTOS
            ...
            <aside className="text-white flex items-center gap-5 w-full lg:w-1/4 lg:flex-row flex-col mt-3 lg:mt-0 h-full">
                ...
                <div className="flex items-center gap-5 flex-col">
                    <a href="https://www.facebook.com" target="_blank"><img src="public/flogo.png" alt=""/></a>
                    <a href="https://www.instagram.com" target="_blank"><img src="public/ilogo.png" alt="" /></a>
                    <a href="https://www.youtube.com" target="_blank"><img src="public/ylogo.png" alt="" /></a>
                    <a href="https://www.twitter.com" target="_blank"><img src="public/tlogo.png" alt="" /></a>
                </div>
